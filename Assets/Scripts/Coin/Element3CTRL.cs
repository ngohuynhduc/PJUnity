...
public class Element3CTRL : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (!gameCtrl.GetComponent<Game3Ctrl>().isEndGame)     
                audioSource.Play();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
       // audioSource.clip = GetCoin;
        //audioSource.Play();
        gameCtrl.GetComponent<Game3Ctrl>().GetPoint();
    ...
    public void EndGame()
    {
        ...
        audioSource.Play();
        gameCtrl.GetComponent<Game3Ctrl>().EndGame();
    }
}
