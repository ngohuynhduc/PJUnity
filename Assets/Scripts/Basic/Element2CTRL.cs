...
public class Element2CTRL : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (!gameCtrl.GetComponent<game2CTRL>().isEndGame)
                audioSource.Play();
    ...
    {
        gameCtrl.GetComponent<game2CTRL>().GetPoint();
    }
    //Hàm EndGame
    public void EndGame()
    {
        ...
        audioSource.Play();
        gameCtrl.GetComponent<game2CTRL>().EndGame();
    }
}
